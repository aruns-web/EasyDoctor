...
def admin_doctor_master_add(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request,'./myapp/admin_doctor_master_add.html')

def admin_doctor_master_view(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request,'./myapp/admin_doctor_master_view.html')
...
def admin_symptom_master_view(request):
    try:
        ...
        return render(request, './myapp/admin_symptom_master_view.html')
...
def admin_disease_master_view(request):
    try:
        ...
        return render(request, './myapp/admin_disease_master_view.html')

def admin_disease_symptom_map_add(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request, './myapp/admin_disease_symptom_map_add.html')

def admin_disease_symptom_map_view(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request, './myapp/admin_disease_symptom_map_view.html')

def admin_disease_drug_map_add(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request, './myapp/admin_disease_drug_map_add.html')

def admin_disease_drug_map_view(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request, './myapp/admin_disease_drug_map_view.html')

def admin_disease_treatment_add(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request, './myapp/admin_disease_treatment_add.html')

def admin_disease_treatment_view(request):
    try:
        uname = request.session['user_name']
        print(uname)
    except:
        ...
        return render(request, './myapp/admin_disease_treatment_view.html')
...
def admin_drug_master_view(request):
    try:
        ...
        return render(request, './myapp/admin_drug_master_view.html')
